  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-else-if="!isAffiliate" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="bg-white rounded-lg shadow p-8 text-center">
        ...
        <button @click="$router.push('/afiliado-cadastro')" class="bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700">
          Tornar-se Afiliado
        </button>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <button
            ...
            class="mt-4 w-full bg-green-600 text-white py-2 rounded hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-sm"
          >
            Solicitar Saque
          </button>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <h3 class="text-sm font-medium text-gray-500">Total Ganho</h3>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <p class="text-3xl font-bold text-blue-600 mt-2">{{ stats.stats.active_referrals }}</p>
        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="flex mt-2">
              ...
              />
              <button @click="copyCoupon" class="bg-purple-600 text-white px-6 py-2 rounded-r-lg hover:bg-purple-700">
          ...
          <div>
            ...
            <div class="flex mt-2">
              ...
              />
              <button @click="copyLink" class="bg-purple-600 text-white px-6 py-2 rounded-r-lg hover:bg-purple-700">
      ...
      <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6">
          ...
          <div v-if="activeTab === 'clients'">
            ...
            <div v-if="stats.referrals.length === 0" class="text-center text-gray-500 py-8">
              ...
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Último Pagamento</th>
                  </tr>
                </thead>
          ...
          <div v-if="activeTab === 'commissions'">
            ...
            <div v-if="stats.commissions.length === 0" class="text-center text-gray-500 py-8">
            ...
            <div v-else class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                  <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Data</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Valor Pago</th>
          ...
          <div v-if="activeTab === 'withdrawals'">
            ...
            <div v-if="stats.withdrawals.length === 0" class="text-center text-gray-500 py-8">
              ...
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Status</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Processado</th>
                  </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
        ...
        <form @submit.prevent="requestWithdraw">
          <div class="mb-4">
            ...
            <input
              ...
              required
            />
            <p class="text-sm text-gray-500 mt-1">Mínimo: R$ 50,00 | Disponível: R$ {{ formatCurrency(stats.affiliate.available_balance) }}</p>
          </div>
          ...
          <div class="mb-4">
            ...
            <input
              ...
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
            />
            <p class="text-sm text-gray-500 mt-1">Se não informar, usaremos o CPF como chave PIX</p>
          </div>
          ...
          <div class="flex gap-3">
            ...
            <button
              ...
              class="flex-1 bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 disabled:bg-gray-400"
            >
...
const getCommissionStatusClass = (status) => {
  const classes = {
    ...
    withdrawn: 'px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-800'
  }
