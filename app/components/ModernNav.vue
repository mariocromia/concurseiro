              ...
              <div v-if="userMenuOpen" ref="dropdownRef" class="absolute right-0 mt-2 w-56 bg-white dark:bg-dark-800 border border-[#E5E5E5] dark:border-dark-700 rounded-claude-md shadow-xl overflow-hidden z-[99999]">
                ...
                <div class="py-1">
                  ...
                  <NuxtLink
                    ...
                    class="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-[#6B6B6B] dark:text-slate-400 hover:text-[#b85635] dark:hover:text-primary-400 hover:bg-[#f0e8e1] dark:hover:bg-slate-800/50 transition-colors"
                  >
                  ...
                  <!-- Admin Links -->
                  <div v-if="isAdmin" class="border-t border-[#E5E5E5] dark:border-dark-700 pt-1 mt-1">
                    <div class="px-4 py-2">
                      <p class="text-xs font-semibold text-red-600 dark:text-red-400 uppercase tracking-wide">Administração</p>
                    </div>
                    <NuxtLink
                      to="/admin/dashboard"
                      @click="userMenuOpen = false"
                      class="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-[#6B6B6B] dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors"
                    >
