  ...
  <footer class="bg-dark-900 border-t border-white/10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid md:grid-cols-4 gap-8 mb-8">
        <!-- Brand -->
        <div>
          <h3 class="text-2xl font-bold text-white mb-4">PraPassar</h3>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            <li><NuxtLink to="/precos" class="hover:text-white transition-colors">Preços</NuxtLink></li>
            <li><NuxtLink to="/register" class="hover:text-white transition-colors">Começar Grátis</NuxtLink></li>
            <li><a href="#" class="hover:text-white transition-colors">Tour pela Plataforma</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            ...
            <li><a href="https://wa.me/5511999999999" target="_blank" class="hover:text-white transition-colors">WhatsApp</a></li>
      ...
      <div class="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="text-gray-400 text-sm">
          © 2025 PraPassar. Todos os direitos reservados.
        </div>
